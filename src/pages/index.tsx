...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>Oleh Vanin - Software Engineer</title>
        <meta
          name="description"
          content="Oleh Vanin is a Ukrainian Senior Full Stack Engineer / AI Engineer based in Poland, building practical AI systems, full-stack products, MCP servers, LLM workflows, and developer tools."
        />
      </Head>
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-col px-4 pb-20 pt-28 sm:px-6 lg:pt-32">
        <section className="grid min-h-[calc(100svh-8rem)] items-center gap-10 py-8 lg:grid-cols-[1.04fr_0.96fr] lg:py-12">
          <div className="max-w-4xl">
            <div className="motion-rise mb-6 inline-flex items-center gap-2 rounded-full border border-border bg-card/70 px-3 py-2 text-xs font-bold tracking-[0.16em] text-muted-foreground shadow-sm backdrop-blur-xl">
            ...
            <p className="motion-rise motion-delay-2 mt-8 max-w-2xl text-pretty text-xl leading-8 text-muted-foreground sm:text-2xl sm:leading-10">
              I am Oleh Vanin, a Ukrainian engineer based in Poland. I build practical AI systems, full-stack products,
              MCP servers, LLM workflows, and developer tools with TypeScript, React, Node.js, Go, and cloud
              infrastructure.
            </p>
            ...
            <div className="motion-rise motion-delay-3 mt-8 flex flex-wrap gap-3">
              ...
              <LiquidGlassLink href="/api/resume/pdf" label="Download CV" rel="noopener noreferrer" variant="glass">
          ...
          <aside className="motion-rise motion-delay-2 liquid-glass relative overflow-hidden rounded-[2rem] p-5">
            ...
            <UiCard className="gap-0 rounded-[1.45rem] border-border bg-card/45 py-0 shadow-none">
              <CardHeader className="flex flex-row items-start justify-between gap-4 px-5 pt-5">
                ...
                <span className="relative block size-20 shrink-0 overflow-hidden rounded-full border border-border bg-muted shadow-lg shadow-foreground/10 ring-4 ring-background/55">
                  <Image
                    src="/images/me/oleh-portrait.jpg"
        ...
        <section className="py-16">
          <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            ...
            <Link href="/projects" className={buttonVariants({ variant: "glass", size: "default" })}>
              All projects
