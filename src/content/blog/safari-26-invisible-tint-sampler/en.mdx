...
import julyReproduction from "../../../../public/images/blog/safari-26-invisible-tint-sampler/july-reproduction.webp";
...
<Figure
  src={julyReproduction}
  alt="Light-themed Blog article in Safari on the iPhone 17 Pro Simulator at 16:26 during the July tinting reproduction"
  caption="16:26 on July 25: the start of the final debugging session, not the start of the Safari problem."
...
<Figure
  ...
  alt="Safari Web Inspector connected to localhost in the iPhone 17 Pro Simulator, showing the page DOM and computed styles"
  caption="Safari Web Inspector attached directly to the Simulator page on localhost."
